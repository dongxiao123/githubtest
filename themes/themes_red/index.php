...
.order-title{ 
	font-size:14px; line-height: 1em; font-weight: normal; padding:10px 10px; background: red; color:#fff; 
}
table{ 
...
#submit{
	border:0; background: red; color:#fff; font-size: 14px; line-height: 1em;padding:10px 40px; 
	border-radius: 3px; 
}
#loading{ 
