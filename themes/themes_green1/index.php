...
#submit{
	border:0; color:#fff; font-size: 14px; line-height: 1em;padding:10px 50px; 
	border-radius: 3px; 
...
<table cellspacing="0">
	<tr>
		<td width="100" align="right">订购产品</td>
		<td width="*">
			<select id="goods_id">
			<?php
  ...
  <tr>
		...
		<td><input type="text" class="text" id="faxing" placeholder="请输入发型代码"></td>
	</tr>
	<tr>
